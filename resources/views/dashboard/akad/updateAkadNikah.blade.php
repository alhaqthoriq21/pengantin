            ...
            <div class="card" id="tambahAkadNikah">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="h3 mb-0">Form Update Akad Nikah</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 card--shadow">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input name="tgl" id="tgl" class="form-control" value="{{$akadNikah->tgl}}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input name="waktu" id="waktu" placeholder="" min="1" type="text"
                                                class="form-control" value="{{$akadNikah->waktu}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input name="tempat" id="tempat" placeholder="" min="1" type="text"
                                                class="form-control" value="{{$akadNikah->tempat}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input name="google_loc" id="google_loc" placeholder="" min="1" type="text"
                                                class="form-control" value="{{$akadNikah->google_loc}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
