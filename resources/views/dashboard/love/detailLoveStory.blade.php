            ...
            <div class="card" id="tambahLoveStory">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="h3 mb-0">Form Detail Love Story</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 card--shadow">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input disabled name="tgl_firstmeet" id="tgl_firstmeet" type="text"
                                ...
                                <div class=" row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <textarea disabled name="story_firstmeet" id="story_firstmeet"
                            ...
                            <div class="col-12 card--shadow">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input disabled name="tgl_firstdate" id="tgl_firstdate" type="text"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <textarea disabled name="story_firstdate" id="story_firstdate"
                                                class="form-control" rows="5" cols="33">
                                            </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 card--shadow">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input disabled name="tgl_relationship" id="tgl_relationship" type="text"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <textarea disabled name="story_relationship" id="story_relationship"
                                                class="form-control" rows="5" cols="33">
                                            </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 card--shadow">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <input disabled name="tgl_enganged" id="tgl_enganged" type="text"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex flex-row">
                                            <textarea disabled name="story_enganged" id="story_enganged"
                                                class="form-control" rows="5" cols="33">
                                            </textarea>
                                        </div>
                                    </div>
