                    ...
                    <div class="guest-wrap">
                        ...
                        <div class="contact-form form-style">
                            <form id="rsvp-form" action="{{route('reservasi.save')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="text" placeholder="Your Name*" id="nama" name="nama" class="form-control">
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-12">
                                        <input type="text" placeholder="Your Address*" id="alamat" name="alamat" class="form-control">
                                    </div>
