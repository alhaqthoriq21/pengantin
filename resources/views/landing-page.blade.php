        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content p4">
              ...
              <h2>To Be a Bride</h2>
              <p>
                Adalah sebuah platform Undangan Pernikahan Online atau Wedding E-Invitation Latter yang menggunakan media website
                untuk membantu anda dalam menyebarkan informasi acara tanpa batas jarak dan waktu. <p>
              <p>
                Wedding E-Invitation Letter ini berisi informasi yang lengkap mulai dari Foto, Musik, Lokasi Pernikahan dengan Google Maps,
              ...
              <div class="row align-self-center gy-4">
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <div>
                    ...
                    <p>Anda bisa merubah nama tamu undangan sesuai keinginan, untuk memberikan kesan yang lebih baik dalam undangan</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div>
                    <h4>Gallery Foto</h4>
                    <p>Anda dapat menampilkan gallery foto terbaik bersama pasangan dalam satu undangan</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <div>
                    ...
                    <p>Tamu undangan bisa menambahkan acara pernikahan anda ke google calender dengan satu kali klik</p>
                  </div>
                </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box bronze">
              ...
              <h3>Tema Bronze</h3>
              <a href="#" class="read-more"><span>Lihat Tema</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
            ...
            <div class="accordion accordion-flush" id="faqlist1">
              <div class="accordion-item">
                ...
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                  <div class="accordion-body">
                    Pembuatan undangan dilakukan oleh admin, client hanya memberikan data yang diminta oleh admin melalui pesan WhatsApp.
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                  <div class="accordion-body">
                    Tema dibagi menjadi beberapa bagian sesuai dengan paket yang dipilih. untuk melihat berbagai tema anda bisa klik menu <a class="scrollto" href="#theme">Pilihan Tema</a>.
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                  <div class="accordion-body">
                    Saat ini pembayaran hanya dilakukan melalui transfer antar bank setelah mengisi format yang diberikan admin melalui pesan WhatsApp. Konfirmasi pembayaran juga dilakukan melalui pesan WhatsApp.
                  </div>
                </div>
              </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile mt-auto">
                  <img src="{{ url('landing-page/img/testimonials/testimonials.png') }}" class="testimonial-img" alt="">
                  <h3>Hani & Gani</h3>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Terimakasih team to be a bride sangat membantu kami dalam mempersingkat waktu untuk membagikan undangan, sukses selalu
                </p>
                <div class="profile mt-auto">
                  <img src="{{ url('landing-page/img/testimonials/testimonials.png') }}" class="testimonial-img" alt="">
                  <h3>Citra & Rio</h3>
        ...
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <div class="social-links mt-3">
              ...
              <a href="https://www.instagram.com/_tobeabride_/" target="_blank" class="instagram"><i class="bi bi-instagram bx bxl-instagram"></i></a>
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a class="scrollto" href="#testimonials">Testimoni</a></li>
            </ul>
          </div>
